...
# Unit tests for SwaggerClient::LinksGetStandardOffersLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetStandardOffersLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetStandardOffersLink.new
  end
  ...
  describe 'test an instance of LinksGetStandardOffersLink' do
    it 'should create an instance of LinksGetStandardOffersLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetStandardOffersLink)
    end
  end
