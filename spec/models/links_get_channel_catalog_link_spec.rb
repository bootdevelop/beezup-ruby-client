...
# Unit tests for SwaggerClient::LinksGetChannelCatalogLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetChannelCatalogLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetChannelCatalogLink.new
  end
  ...
  describe 'test an instance of LinksGetChannelCatalogLink' do
    it 'should create an instance of LinksGetChannelCatalogLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetChannelCatalogLink)
    end
  end
