...
# Unit tests for SwaggerClient::LinksGetStoreSharesLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetStoreSharesLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetStoreSharesLink.new
  end
  ...
  describe 'test an instance of LinksGetStoreSharesLink' do
    it 'should create an instance of LinksGetStoreSharesLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetStoreSharesLink)
    end
  end
