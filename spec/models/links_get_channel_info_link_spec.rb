...
# Unit tests for SwaggerClient::LinksGetChannelInfoLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetChannelInfoLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetChannelInfoLink.new
  end
  ...
  describe 'test an instance of LinksGetChannelInfoLink' do
    it 'should create an instance of LinksGetChannelInfoLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetChannelInfoLink)
    end
  end
