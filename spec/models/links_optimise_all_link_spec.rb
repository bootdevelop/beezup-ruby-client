...
# Unit tests for SwaggerClient::LinksOptimiseAllLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksOptimiseAllLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksOptimiseAllLink.new
  end
  ...
  describe 'test an instance of LinksOptimiseAllLink' do
    it 'should create an instance of LinksOptimiseAllLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksOptimiseAllLink)
    end
  end
