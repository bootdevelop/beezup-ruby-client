...
# Unit tests for SwaggerClient::LinksDeleteStoreShareLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksDeleteStoreShareLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksDeleteStoreShareLink.new
  end
  ...
  describe 'test an instance of LinksDeleteStoreShareLink' do
    it 'should create an instance of LinksDeleteStoreShareLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksDeleteStoreShareLink)
    end
  end
