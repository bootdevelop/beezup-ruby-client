...
# Unit tests for SwaggerClient::LinksImportationMapCustomColumnLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksImportationMapCustomColumnLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksImportationMapCustomColumnLink.new
  end
  ...
  describe 'test an instance of LinksImportationMapCustomColumnLink' do
    it 'should create an instance of LinksImportationMapCustomColumnLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksImportationMapCustomColumnLink)
    end
  end
