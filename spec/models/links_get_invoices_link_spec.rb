...
# Unit tests for SwaggerClient::LinksGetInvoicesLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetInvoicesLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetInvoicesLink.new
  end
  ...
  describe 'test an instance of LinksGetInvoicesLink' do
    it 'should create an instance of LinksGetInvoicesLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetInvoicesLink)
    end
  end
