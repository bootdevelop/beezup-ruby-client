...
# Unit tests for SwaggerClient::LinksAddChannelCatalogLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksAddChannelCatalogLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksAddChannelCatalogLink.new
  end
  ...
  describe 'test an instance of LinksAddChannelCatalogLink' do
    it 'should create an instance of LinksAddChannelCatalogLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksAddChannelCatalogLink)
    end
  end
