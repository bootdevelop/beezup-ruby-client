...
# Unit tests for SwaggerClient::LinksAnalyticsIndexLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksAnalyticsIndexLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksAnalyticsIndexLink.new
  end
  ...
  describe 'test an instance of LinksAnalyticsIndexLink' do
    it 'should create an instance of LinksAnalyticsIndexLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksAnalyticsIndexLink)
    end
  end
