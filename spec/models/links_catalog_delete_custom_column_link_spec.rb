...
# Unit tests for SwaggerClient::LinksCatalogDeleteCustomColumnLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksCatalogDeleteCustomColumnLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksCatalogDeleteCustomColumnLink.new
  end
  ...
  describe 'test an instance of LinksCatalogDeleteCustomColumnLink' do
    it 'should create an instance of LinksCatalogDeleteCustomColumnLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksCatalogDeleteCustomColumnLink)
    end
  end
