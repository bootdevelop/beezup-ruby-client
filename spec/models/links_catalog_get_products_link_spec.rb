...
# Unit tests for SwaggerClient::LinksCatalogGetProductsLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksCatalogGetProductsLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksCatalogGetProductsLink.new
  end
  ...
  describe 'test an instance of LinksCatalogGetProductsLink' do
    it 'should create an instance of LinksCatalogGetProductsLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksCatalogGetProductsLink)
    end
  end
