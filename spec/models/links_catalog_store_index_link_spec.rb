...
# Unit tests for SwaggerClient::LinksCatalogStoreIndexLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksCatalogStoreIndexLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksCatalogStoreIndexLink.new
  end
  ...
  describe 'test an instance of LinksCatalogStoreIndexLink' do
    it 'should create an instance of LinksCatalogStoreIndexLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksCatalogStoreIndexLink)
    end
  end
