...
# Unit tests for SwaggerClient::LinksSaveStoreAlertsLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksSaveStoreAlertsLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksSaveStoreAlertsLink.new
  end
  ...
  describe 'test an instance of LinksSaveStoreAlertsLink' do
    it 'should create an instance of LinksSaveStoreAlertsLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksSaveStoreAlertsLink)
    end
  end
