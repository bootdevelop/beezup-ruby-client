...
# Unit tests for SwaggerClient::CreateSubscriptionRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSubscriptionRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateSubscriptionRequest.new
  end
  ...
  describe 'test an instance of CreateSubscriptionRequest' do
    it 'should create an instance of CreateSubscriptionRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateSubscriptionRequest)
    end
  end
