...
# Unit tests for SwaggerClient::LinksGetCustomerIndexLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetCustomerIndexLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetCustomerIndexLink.new
  end
  ...
  describe 'test an instance of LinksGetCustomerIndexLink' do
    it 'should create an instance of LinksGetCustomerIndexLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetCustomerIndexLink)
    end
  end
