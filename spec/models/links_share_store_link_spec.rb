...
# Unit tests for SwaggerClient::LinksShareStoreLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksShareStoreLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksShareStoreLink.new
  end
  ...
  describe 'test an instance of LinksShareStoreLink' do
    it 'should create an instance of LinksShareStoreLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksShareStoreLink)
    end
  end
