...
# Unit tests for SwaggerClient::LinksGetOfferLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetOfferLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetOfferLink.new
  end
  ...
  describe 'test an instance of LinksGetOfferLink' do
    it 'should create an instance of LinksGetOfferLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetOfferLink)
    end
  end
