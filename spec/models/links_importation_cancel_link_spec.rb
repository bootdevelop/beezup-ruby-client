...
# Unit tests for SwaggerClient::LinksImportationCancelLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksImportationCancelLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksImportationCancelLink.new
  end
  ...
  describe 'test an instance of LinksImportationCancelLink' do
    it 'should create an instance of LinksImportationCancelLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksImportationCancelLink)
    end
  end
