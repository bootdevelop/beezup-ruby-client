...
# Unit tests for SwaggerClient::LinksGetChannelCatalogsLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetChannelCatalogsLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetChannelCatalogsLink.new
  end
  ...
  describe 'test an instance of LinksGetChannelCatalogsLink' do
    it 'should create an instance of LinksGetChannelCatalogsLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetChannelCatalogsLink)
    end
  end
