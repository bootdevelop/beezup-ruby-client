...
# Unit tests for SwaggerClient::LinksImportationCommitLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksImportationCommitLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksImportationCommitLink.new
  end
  ...
  describe 'test an instance of LinksImportationCommitLink' do
    it 'should create an instance of LinksImportationCommitLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksImportationCommitLink)
    end
  end
