...
# Unit tests for SwaggerClient::LinksGetTrackingStatusLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetTrackingStatusLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetTrackingStatusLink.new
  end
  ...
  describe 'test an instance of LinksGetTrackingStatusLink' do
    it 'should create an instance of LinksGetTrackingStatusLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetTrackingStatusLink)
    end
  end
