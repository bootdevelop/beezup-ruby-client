...
# Unit tests for SwaggerClient::LinksGetStoreReportByDayLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetStoreReportByDayLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetStoreReportByDayLink.new
  end
  ...
  describe 'test an instance of LinksGetStoreReportByDayLink' do
    it 'should create an instance of LinksGetStoreReportByDayLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetStoreReportByDayLink)
    end
  end
