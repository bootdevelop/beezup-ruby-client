...
# Unit tests for SwaggerClient::LinksCatalogIndexLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksCatalogIndexLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksCatalogIndexLink.new
  end
  ...
  describe 'test an instance of LinksCatalogIndexLink' do
    it 'should create an instance of LinksCatalogIndexLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksCatalogIndexLink)
    end
  end
