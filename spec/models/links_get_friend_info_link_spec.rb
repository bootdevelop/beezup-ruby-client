...
# Unit tests for SwaggerClient::LinksGetFriendInfoLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetFriendInfoLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetFriendInfoLink.new
  end
  ...
  describe 'test an instance of LinksGetFriendInfoLink' do
    it 'should create an instance of LinksGetFriendInfoLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetFriendInfoLink)
    end
  end
