...
# Unit tests for SwaggerClient::LinksGetUserAccountInfoLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetUserAccountInfoLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetUserAccountInfoLink.new
  end
  ...
  describe 'test an instance of LinksGetUserAccountInfoLink' do
    it 'should create an instance of LinksGetUserAccountInfoLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetUserAccountInfoLink)
    end
  end
