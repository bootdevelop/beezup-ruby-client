...
# Unit tests for SwaggerClient::LinksImportationReattendColumnLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksImportationReattendColumnLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksImportationReattendColumnLink.new
  end
  ...
  describe 'test an instance of LinksImportationReattendColumnLink' do
    it 'should create an instance of LinksImportationReattendColumnLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksImportationReattendColumnLink)
    end
  end
