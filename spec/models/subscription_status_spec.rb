...
# Unit tests for SwaggerClient::SubscriptionStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionStatus' do
  before do
    # run before each test
    @instance = SwaggerClient::SubscriptionStatus.new
  end
  ...
  describe 'test an instance of SubscriptionStatus' do
    it 'should create an instance of SubscriptionStatus' do
      expect(@instance).to be_instance_of(SwaggerClient::SubscriptionStatus)
    end
  end
end
