...
# Unit tests for SwaggerClient::LinksGetBillingPeriodsLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetBillingPeriodsLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetBillingPeriodsLink.new
  end
  ...
  describe 'test an instance of LinksGetBillingPeriodsLink' do
    it 'should create an instance of LinksGetBillingPeriodsLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetBillingPeriodsLink)
    end
  end
