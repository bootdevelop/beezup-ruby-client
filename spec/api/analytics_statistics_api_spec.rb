...
# Unit tests for SwaggerClient::AnalyticsStatisticsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnalyticsStatisticsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::AnalyticsStatisticsApi.new
  end
  ...
  describe 'test an instance of AnalyticsStatisticsApi' do
    it 'should create an instance of AnalyticsStatisticsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::AnalyticsStatisticsApi)
    end
  end
