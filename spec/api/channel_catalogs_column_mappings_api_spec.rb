...
describe 'ChannelCatalogsColumnMappingsApi' do
  ...
  describe 'test an instance of ChannelCatalogsColumnMappingsApi' do
    it 'should create an instance of ChannelCatalogsColumnMappingsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ChannelCatalogsColumnMappingsApi)
    end
  end

  # unit tests for configure_channel_catalog_column_mappings
  ...
  # @return [nil]
  describe 'configure_channel_catalog_column_mappings test' do
    it "should work" do
