...
describe 'ChannelCatalogsProductsApi' do
  ...
  describe 'test an instance of ChannelCatalogsProductsApi' do
    it 'should create an instance of ChannelCatalogsProductsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ChannelCatalogsProductsApi)
    end
  end

  # unit tests for export_channel_catalog_product_info_list
  ...
  describe 'export_channel_catalog_product_info_list test' do
    it "should work" do
  ...
  # unit tests for get_channel_catalog_products_counters
  # Get channel catalog products&#39; counters
  # 
  # @param channel_catalog_id The channel catalog identifier
  # @param [Hash] opts the optional parameters
  # @return [ChannelCatalogProductsCounters]
  describe 'get_channel_catalog_products_counters test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
