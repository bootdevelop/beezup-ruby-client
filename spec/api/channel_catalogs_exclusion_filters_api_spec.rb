...
describe 'ChannelCatalogsExclusionFiltersApi' do
  ...
  describe 'test an instance of ChannelCatalogsExclusionFiltersApi' do
    it 'should create an instance of ChannelCatalogsExclusionFiltersApi' do
  ...
  # unit tests for get_channel_catalog_exclusion_filters
  # Get channel catalog exclusion filters
  # 
  # @param channel_catalog_id The channel catalog identifier
  # @param [Hash] opts the optional parameters
  # @return [ExclusionFiltersResponse]
  describe 'get_channel_catalog_exclusion_filters test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
