...
describe 'ChannelCatalogsProductsOverridesApi' do
  ...
  describe 'test an instance of ChannelCatalogsProductsOverridesApi' do
    it 'should create an instance of ChannelCatalogsProductsOverridesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ChannelCatalogsProductsOverridesApi)
    end
  end

  # unit tests for configure_channel_catalog_product_value_override_copy
  ...
  # @return [nil]
  describe 'configure_channel_catalog_product_value_override_copy test' do
    it "should work" do
  ...
  # unit tests for get_channel_catalog_product_value_override_copy
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'get_channel_catalog_product_value_override_copy test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for override_channel_catalog_product_values
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'override_channel_catalog_product_values test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
