...
describe 'ChannelCatalogsExportationsApi' do
  ...
  describe 'test an instance of ChannelCatalogsExportationsApi' do
    it 'should create an instance of ChannelCatalogsExportationsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ChannelCatalogsExportationsApi)
    end
  end

  # unit tests for clear_channel_catalog_exportation_cache
  # Clear the exportation cache
  # 
  # @param channel_catalog_id The channel catalog identifier
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'clear_channel_catalog_exportation_cache test' do
    it "should work" do
