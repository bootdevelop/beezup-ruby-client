  ...
  class MarketplacesChannelCatalogsPublicationsApi
    ...
    def get_publications_with_http_info(marketplace_technical_code, account_id, opts = {})
      ...
      if @api_client.config.client_side_validation && marketplace_technical_code.nil?
        fail ArgumentError, "Missing the required parameter 'marketplace_technical_code' when calling MarketplacesChannelCatalogsPublicationsApi.get_publications"
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling MarketplacesChannelCatalogsPublicationsApi.get_publications"
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'count'].nil? && opts[:'count'] < 10
      ...
      if @api_client.config.client_side_validation && opts[:'publication_types'] && !opts[:'publication_types'].all?{|item| ['PublishProducts', 'PublishOffers', 'Unpublish'].include?(item)}
        fail ArgumentError, 'invalid value for "publication_types", must include one of PublishProducts, PublishOffers, Unpublish'
      end
      # resource path
      local_var_path = "/user/marketplaces/channelcatalogs/publications/{marketplaceTechnicalCode}/{accountId}/history".sub('{' + 'marketplaceTechnicalCode' + '}', marketplace_technical_code.to_s).sub('{' + 'accountId' + '}', account_id.to_s)
