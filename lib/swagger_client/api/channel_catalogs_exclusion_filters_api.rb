  ...
  class ChannelCatalogsExclusionFiltersApi
    ...
    def configure_channel_catalog_exclusion_filters_with_http_info(channel_catalog_id, request, opts = {})
      ...
      if @api_client.config.client_side_validation && channel_catalog_id.nil?
        fail ArgumentError, "Missing the required parameter 'channel_catalog_id' when calling ChannelCatalogsExclusionFiltersApi.configure_channel_catalog_exclusion_filters"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling ChannelCatalogsExclusionFiltersApi.configure_channel_catalog_exclusion_filters"
      end
      # resource path
      local_var_path = "/user/channelCatalogs/{channelCatalogId}/exclusionFilters".sub('{' + 'channelCatalogId' + '}', channel_catalog_id.to_s)
    ...
    def get_channel_catalog_exclusion_filter_operators_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/channelCatalogs/exclusionFilterOperators"
    ...
    def get_channel_catalog_exclusion_filters(channel_catalog_id, opts = {})
      data, _status_code, _headers = get_channel_catalog_exclusion_filters_with_http_info(channel_catalog_id, opts)
      return data
    end
    ...
    # @param channel_catalog_id The channel catalog identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(ExclusionFiltersResponse, Fixnum, Hash)>] ExclusionFiltersResponse data, response status code and response headers
    def get_channel_catalog_exclusion_filters_with_http_info(channel_catalog_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ChannelCatalogsExclusionFiltersApi.get_channel_catalog_exclusion_filters ..."
      end
      # verify the required parameter 'channel_catalog_id' is set
      if @api_client.config.client_side_validation && channel_catalog_id.nil?
        fail ArgumentError, "Missing the required parameter 'channel_catalog_id' when calling ChannelCatalogsExclusionFiltersApi.get_channel_catalog_exclusion_filters"
      end
      # resource path
      local_var_path = "/user/channelCatalogs/{channelCatalogId}/exclusionFilters".sub('{' + 'channelCatalogId' + '}', channel_catalog_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ExclusionFiltersResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChannelCatalogsExclusionFiltersApi#get_channel_catalog_exclusion_filters\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
