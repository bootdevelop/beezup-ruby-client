  ...
  class ChannelCatalogsProductsOptimisationApi
    ...
    def disable_channel_catalog_product_with_http_info(channel_catalog_id, product_id, opts = {})
      ...
      if @api_client.config.client_side_validation && channel_catalog_id.nil?
        fail ArgumentError, "Missing the required parameter 'channel_catalog_id' when calling ChannelCatalogsProductsOptimisationApi.disable_channel_catalog_product"
      end
      # verify the required parameter 'product_id' is set
      if @api_client.config.client_side_validation && product_id.nil?
        fail ArgumentError, "Missing the required parameter 'product_id' when calling ChannelCatalogsProductsOptimisationApi.disable_channel_catalog_product"
      end
      # resource path
      local_var_path = "/user/channelCatalogs/{channelCatalogId}/products/{productId}/disable".sub('{' + 'channelCatalogId' + '}', channel_catalog_id.to_s).sub('{' + 'productId' + '}', product_id.to_s)
    ...
    def reenable_channel_catalog_product_with_http_info(channel_catalog_id, product_id, opts = {})
      ...
      # verify the required parameter 'channel_catalog_id' is set
      if @api_client.config.client_side_validation && channel_catalog_id.nil?
        fail ArgumentError, "Missing the required parameter 'channel_catalog_id' when calling ChannelCatalogsProductsOptimisationApi.reenable_channel_catalog_product"
      end
      # verify the required parameter 'product_id' is set
      if @api_client.config.client_side_validation && product_id.nil?
        fail ArgumentError, "Missing the required parameter 'product_id' when calling ChannelCatalogsProductsOptimisationApi.reenable_channel_catalog_product"
      end
      # resource path
      local_var_path = "/user/channelCatalogs/{channelCatalogId}/products/{productId}/reenable".sub('{' + 'channelCatalogId' + '}', channel_catalog_id.to_s).sub('{' + 'productId' + '}', product_id.to_s)
