  ...
  class PublicListOfValuesLOVApi
    ...
    def get_public_list_of_values_with_http_info(list_name, opts = {})
      ...
      if @api_client.config.client_side_validation && list_name.nil?
        fail ArgumentError, "Missing the required parameter 'list_name' when calling PublicListOfValuesLOVApi.get_public_list_of_values"
      end
      # resource path
      local_var_path = "/public/lov/{listName}".sub('{' + 'listName' + '}', list_name.to_s)
