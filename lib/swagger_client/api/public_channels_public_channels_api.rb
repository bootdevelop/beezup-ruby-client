  ...
  class PublicChannelsPublicChannelsApi
    ...
    def get_channels_with_http_info(country_iso_code, accept_encoding, opts = {})
      ...
      if @api_client.config.client_side_validation && country_iso_code.nil?
        fail ArgumentError, "Missing the required parameter 'country_iso_code' when calling PublicChannelsPublicChannelsApi.get_channels"
      end
      # verify the required parameter 'accept_encoding' is set
      if @api_client.config.client_side_validation && accept_encoding.nil?
        fail ArgumentError, "Missing the required parameter 'accept_encoding' when calling PublicChannelsPublicChannelsApi.get_channels"
      end
      # resource path
      local_var_path = "/public/channels/{countryIsoCode}".sub('{' + 'countryIsoCode' + '}', country_iso_code.to_s)
    ...
    def get_channels_index_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/public/channels/"
