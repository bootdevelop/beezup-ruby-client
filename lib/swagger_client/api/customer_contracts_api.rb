...
module SwaggerClient
  class CustomerContractsApi
    ...
    # @param request 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateContractResponse, Fixnum, Hash)>] CreateContractResponse data, response status code and response headers
    def create_contract_with_http_info(request, opts = {})
      ...
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling CustomerContractsApi.create_contract"
      end
      # resource path
      local_var_path = "/user/customer/contracts"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CreateContractResponse')
      if @api_client.config.debugging
    ...
    def delete_next_contract_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/customer/contracts/next"
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :if_none_match ETag value to identify the last known version of requested resource.\\ To avoid useless exchange, we recommend you to indicate the ETag you previously got from this operation.\\ If the ETag value does not match the response will be 200 to give you a new content, otherwise the response will be: 304 Not Modified, without any content.\\ For more details go to this link: http://tools.ietf.org/html/rfc7232#section-2.3 
    # @return [Array<(BillingPeriodList, Fixnum, Hash)>] BillingPeriodList data, response status code and response headers
    def get_billing_periods_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/customer/billingPeriods"
    ...
    def get_offer_with_http_info(request, opts = {})
      ...
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling CustomerContractsApi.get_offer"
      end
      # resource path
      local_var_path = "/user/customer/offers"
    ...
    def reactivate_current_contract_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/user/customer/contracts/current/reenableAutoRenewal"
    ...
    def terminate_current_contract_with_http_info(request, opts = {})
      ...
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling CustomerContractsApi.terminate_current_contract"
      end
      # resource path
      local_var_path = "/user/customer/contracts/current/disableAutoRenewal"
