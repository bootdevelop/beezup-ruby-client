  ...
  class CustomerFriendsApi
    ...
    def get_friend_info_with_http_info(user_id, opts = {})
      ...
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling CustomerFriendsApi.get_friend_info"
      end
      # resource path
      local_var_path = "/user/customer/friends/{userId}".sub('{' + 'userId' + '}', user_id.to_s)
