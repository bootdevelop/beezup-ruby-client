...
module SwaggerClient
  class ChannelCatalogsGlobalApi
    ...
    def add_channel_catalog(request, opts = {})
      data, _status_code, _headers = add_channel_catalog_with_http_info(request, opts)
      return data
    end
    ...
    # @param request 
    # @param [Hash] opts the optional parameters
    # @return [Array<(LinksGetChannelCatalogLink, Fixnum, Hash)>] LinksGetChannelCatalogLink data, response status code and response headers
    def add_channel_catalog_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ChannelCatalogsGlobalApi.add_channel_catalog ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling ChannelCatalogsGlobalApi.add_channel_catalog"
      end
      # resource path
      local_var_path = "/user/channelCatalogs/"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'LinksGetChannelCatalogLink')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChannelCatalogsGlobalApi#add_channel_catalog\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_channel_catalog_with_http_info(channel_catalog_id, opts = {})
      ...
      if @api_client.config.client_side_validation && channel_catalog_id.nil?
        fail ArgumentError, "Missing the required parameter 'channel_catalog_id' when calling ChannelCatalogsGlobalApi.delete_channel_catalog"
      end
      # resource path
      local_var_path = "/user/channelCatalogs/{channelCatalogId}".sub('{' + 'channelCatalogId' + '}', channel_catalog_id.to_s)
    ...
    def get_channel_catalog_with_http_info(channel_catalog_id, opts = {})
      ...
      # verify the required parameter 'channel_catalog_id' is set
      if @api_client.config.client_side_validation && channel_catalog_id.nil?
        fail ArgumentError, "Missing the required parameter 'channel_catalog_id' when calling ChannelCatalogsGlobalApi.get_channel_catalog"
      end
      # resource path
      local_var_path = "/user/channelCatalogs/{channelCatalogId}".sub('{' + 'channelCatalogId' + '}', channel_catalog_id.to_s)
