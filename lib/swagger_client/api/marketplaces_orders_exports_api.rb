  ...
  class MarketplacesOrdersExportsApi
    ...
    def export_orders_with_http_info(request, opts = {})
      ...
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling MarketplacesOrdersExportsApi.export_orders"
      end
      # resource path
      local_var_path = "/user/marketplaces/orders/exportations"
    ...
    def get_order_exportations_with_http_info(page_number, page_size, store_id, opts = {})
      ...
      if @api_client.config.client_side_validation && page_number.nil?
        fail ArgumentError, "Missing the required parameter 'page_number' when calling MarketplacesOrdersExportsApi.get_order_exportations"
      end
      ...
      if @api_client.config.client_side_validation && page_size.nil?
        fail ArgumentError, "Missing the required parameter 'page_size' when calling MarketplacesOrdersExportsApi.get_order_exportations"
      end
      ...
      if @api_client.config.client_side_validation && store_id.nil?
        fail ArgumentError, "Missing the required parameter 'store_id' when calling MarketplacesOrdersExportsApi.get_order_exportations"
      end
      # resource path
      local_var_path = "/user/marketplaces/orders/exportations"
