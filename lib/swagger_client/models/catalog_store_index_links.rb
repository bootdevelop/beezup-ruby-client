...
module SwaggerClient
  ...
  class CatalogStoreIndexLinks
    ...
    attr_accessor :auto_import_info

    attr_accessor :importations

    attr_accessor :start_importation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'inputConfiguration')
        self.input_configuration = attributes[:'inputConfiguration']
      end

      if attributes.has_key?(:'autoImportInfo')
        self.auto_import_info = attributes[:'autoImportInfo']
      end

      if attributes.has_key?(:'importations')
        self.importations = attributes[:'importations']
      end

      if attributes.has_key?(:'startImportation')
        self.start_importation = attributes[:'startImportation']
      end
      ...
      if attributes.has_key?(:'randomProducts')
        self.random_products = attributes[:'randomProducts']
      end

      if attributes.has_key?(:'computeExpression')
        self.compute_expression = attributes[:'computeExpression']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _self == o._self &&
          input_configuration == o.input_configuration &&
          auto_import_info == o.auto_import_info &&
          importations == o.importations &&
          start_importation == o.start_importation &&
          catalog_columns == o.catalog_columns &&
          custom_columns == o.custom_columns &&
          categories == o.categories &&
          products == o.products &&
          random_products == o.random_products &&
          compute_expression == o.compute_expression
    end
    ...
    def hash
      [_self, input_configuration, auto_import_info, importations, start_importation, catalog_columns, custom_columns, categories, products, random_products, compute_expression].hash
    end
