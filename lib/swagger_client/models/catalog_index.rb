...
module SwaggerClient
  ...
  class CatalogIndex
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'storeLinks')
        self.store_links = attributes[:'storeLinks']
      end
    ...
    def hash
      [links, lov_links, store_links].hash
    end
