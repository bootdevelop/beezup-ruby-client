...
module SwaggerClient
  ...
  class AutoImportConfigurationLinks
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'scheduleInterval')
        self.schedule_interval = attributes[:'scheduleInterval']
      end
    ...
    def hash
      [_self, activate, start, pause, resume, schedule_interval, schedule].hash
    end
