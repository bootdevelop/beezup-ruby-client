...
module SwaggerClient
  ...
  class OrderedReportFilterCommonParameters
    ...
    def hash
      [channel_id, period_type, begin_period_utc_date, end_period_utc_date, category_filter, performance_indicator_filters, advanced_filters, order_by, order_by_direction].hash
    end
