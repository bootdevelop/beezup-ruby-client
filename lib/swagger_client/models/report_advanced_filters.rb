...
module SwaggerClient
  ...
  class ReportAdvancedFilters
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'marginType')
        self.margin_type = attributes[:'marginType']
      end
    ...
    def list_invalid_properties
      ...
      if @margin_type.nil?
        invalid_properties.push("invalid value for 'margin_type', margin_type cannot be nil.")
      end
    ...
    def valid?
      return false if @margin_type.nil?
    ...
    def hash
      [margin_type, global_margin_percent, link_click_to_order_type, link_click_to_order_max_day, only_payment_validated_orders, only_direct_sales, performance_indicator_formula].hash
    end
