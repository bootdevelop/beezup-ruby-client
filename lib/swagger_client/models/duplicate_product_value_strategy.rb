...
module SwaggerClient
  class DuplicateProductValueStrategy
    ...
    def build_from_hash(value)
      constantValues = DuplicateProductValueStrategy.constants.select{|c| DuplicateProductValueStrategy::const_get(c) == value}
      raise "Invalid ENUM value #{value} for class #DuplicateProductValueStrategy" if constantValues.empty?
      value
    end
  end
