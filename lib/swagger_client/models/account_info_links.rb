...
module SwaggerClient
  ...
  class AccountInfoLinks
    ...
    attr_accessor :activate_user_account
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'activateUserAccount')
        self.activate_user_account = attributes[:'activateUserAccount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          activate_user_account == o.activate_user_account
    end
    ...
    def hash
      [_self, save_personal_info, change_password, save_company_info, get_profile_picture_info, save_profile_picture_info, get_credit_card_info, save_credit_card_info, activate_user_account].hash
    end
