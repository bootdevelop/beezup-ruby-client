...
module SwaggerClient
  ...
  class ReportByChannel
    ...
    def hash
      [channel, catalog_product_count, enabled_product_count, click_count, cost, order_count, roi, margin, performance_indicator, total_sales, sold_product_count, links].hash
    end
