...
module SwaggerClient
  ...
  class ReportByProductRequest
    ...
    def hash
      [channel_id, period_type, begin_period_utc_date, end_period_utc_date, category_filter, performance_indicator_filters, advanced_filters, order_by, order_by_direction, page_size, page_number, product_columns_to_display, product_state, analytics_product_column_filters].hash
    end
