...
module SwaggerClient
  ...
  class OrderListRequest
    ...
    def hash
      [marketplace_technical_codes, marketplace_business_codes, account_ids, store_ids, beez_up_order_statuses, date_search_type, begin_period_utc_date, end_period_utc_date, order_buyer_name, marketplace_order_ids, order_merchant_order_ids, page_size, page_number].hash
    end
