...
module SwaggerClient
  ...
  class ChannelCatalogLinks
    ...
    attr_accessor :configure_general_settings

    attr_accessor :configure_cost_settings

    attr_accessor :configure_column_mappings

    attr_accessor :reenable_category_mappings

    attr_accessor :disable_category_mappings

    attr_accessor :category_mappings

    attr_accessor :exclusion_filters

    attr_accessor :products

    attr_accessor :exportation_cache_info

    attr_accessor :marketplace_settings
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'configureGeneralSettings')
        self.configure_general_settings = attributes[:'configureGeneralSettings']
      end

      if attributes.has_key?(:'configureCostSettings')
        self.configure_cost_settings = attributes[:'configureCostSettings']
      end

      if attributes.has_key?(:'configureColumnMappings')
        self.configure_column_mappings = attributes[:'configureColumnMappings']
      end

      if attributes.has_key?(:'reenableCategoryMappings')
        self.reenable_category_mappings = attributes[:'reenableCategoryMappings']
      end

      if attributes.has_key?(:'disableCategoryMappings')
        self.disable_category_mappings = attributes[:'disableCategoryMappings']
      end

      if attributes.has_key?(:'categoryMappings')
        self.category_mappings = attributes[:'categoryMappings']
      end
      ...
      if attributes.has_key?(:'exportationCacheInfo')
        self.exportation_cache_info = attributes[:'exportationCacheInfo']
      end

      if attributes.has_key?(:'marketplaceSettings')
        self.marketplace_settings = attributes[:'marketplaceSettings']
      end

      if attributes.has_key?(:'channelInfo')
        self.channel_info = attributes[:'channelInfo']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enable == o.enable &&
          disable == o.disable &&
          configure_general_settings == o.configure_general_settings &&
          configure_cost_settings == o.configure_cost_settings &&
          configure_column_mappings == o.configure_column_mappings &&
          reenable_category_mappings == o.reenable_category_mappings &&
          disable_category_mappings == o.disable_category_mappings &&
          category_mappings == o.category_mappings &&
          exclusion_filters == o.exclusion_filters &&
          products == o.products &&
          exportation_cache_info == o.exportation_cache_info &&
          marketplace_settings == o.marketplace_settings &&
    ...
    def hash
      [_self, delete, enable, disable, configure_general_settings, configure_cost_settings, configure_column_mappings, reenable_category_mappings, disable_category_mappings, category_mappings, exclusion_filters, products, exportation_cache_info, marketplace_settings, channel_info].hash
    end
