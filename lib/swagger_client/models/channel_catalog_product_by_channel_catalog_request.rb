...
module SwaggerClient
  ...
  class ChannelCatalogProductByChannelCatalogRequest
    ...
    def list_invalid_properties
      ...
      if @channel_catalog_ids.nil?
        invalid_properties.push("invalid value for 'channel_catalog_ids', channel_catalog_ids cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @channel_catalog_ids.nil?
      return true
    end
    ...
    def hash
      [store_id, product_id, channel_catalog_ids].hash
    end
