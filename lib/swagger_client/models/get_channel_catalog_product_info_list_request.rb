...
module SwaggerClient
  ...
  class GetChannelCatalogProductInfoListRequest
    ...
    attr_accessor :catalog_category_filter

    attr_accessor :channel_category_filter
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'product_filters' => :'BeezUPCommonProductFilters',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'catalogCategoryFilter')
        self.catalog_category_filter = attributes[:'catalogCategoryFilter']
      end

      if attributes.has_key?(:'channelCategoryFilter')
        self.channel_category_filter = attributes[:'channelCategoryFilter']
      end
    ...
    def list_invalid_properties
      ...
      if @page_size < 100
        invalid_properties.push("invalid value for 'page_size', must be greater than or equal to 100.")
      end
    ...
    def page_size=(page_size)
      ...
      if page_size < 100
        fail ArgumentError, "invalid value for 'page_size', must be greater than or equal to 100."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          catalog_category_filter == o.catalog_category_filter &&
          channel_category_filter == o.channel_category_filter
    end
    ...
    def hash
      [page_number, page_size, criteria, overridden, product_filters, catalog_category_filter, channel_category_filter].hash
    end
