...
module SwaggerClient
  ...
  class ReportByDayByChannel
    ...
    def list_invalid_properties
      ...
      if @roi.nil?
        invalid_properties.push("invalid value for 'roi', roi cannot be nil.")
      end
    ...
    def hash
      [click_count, cost, order_count, roi, margin, performance_indicator, total_sales, sold_product_count, channel].hash
    end
